        ...
        <View style={{
            ...
            <View style={
                ...
                <Image
                    ...
                    source={require("../assets/path_yellow.png")} />
            ...
            <View style={
                ...
                <Button onPress={() => navigate('IntroScreenThree')} style={{
...
export default withNavigation(IntroScreenTwo)